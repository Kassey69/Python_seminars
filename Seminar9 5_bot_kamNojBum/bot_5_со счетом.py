...
@bot.message_handler(
    func=lambda message: message.text in ['Камень', 'Ножницы', 'Бумага'] \
        and users.get(message.from_user.id, {}).get(
...
# источник = https://ru.stackoverflow.com/questions/1422571/Счетчик-побед-и-поражений-в-Телеграм-боте