...
def izm():
    ...
    with open('E:\Programming\Visual_Studio_Code\Python_seminars_replay\Seminar8_2\sleSH2_file.txt', \
        ...
        with open("E:\Programming\Visual_Studio_Code\Python_seminars_replay\Seminar8_2\ееemp.txt", "w",\
            ...
            with open("E:\Programming\Visual_Studio_Code\Python_seminars_replay\Seminar8_2\ееempl.txt", "a",\
    ...
    data = []
    with open('E:\Programming\Visual_Studio_Code\Python_seminars_replay\Seminar8_2\sleSH3_file.txt', \
    ...
    f1.write('\n' + f2.read() + '\n') # переносит на другую строчку но наблюдается разрыв.
